...
class ReportesController extends Controller
{
    ...
    public function getReporte1(Request $request)
    {
        ...
        try {
            $resOrdenes = DB::select('SELECT * FROM RES_ANUAL_MES_ORDENES WHERE ANIO= ?', [$año]);
            $resProductos = DB::select('SELECT * FROM RES_ANUAL_MES_PRODUCTOS WHERE ANIO= ?', [$año]);
    ...
    public function getReporte2(Request $request)
    {
        ...
        try {
            ...
            $resVentas = DB::select('SELECT * FROM RES_ANUAL_MES_VENTAS WHERE ANIO= ?', [$año]);
    ...
    public function getReporte3(Request $request)
    {
        ...
        try {
            ...
            $data = DB::select('SELECT * FROM RES_TOP_ESPECIALIDAD_MES_VENTA WHERE ANIO= ? AND COD_ESPECIALIDAD=? AND COD_MES =?  ORDER BY POSICION_TOP ASC', [$año, $especialidad, $mes]);
    ...
    public function getReporte4(Request $request)
    {
        ...
        try {
            ...
            $resVentas = DB::select('SELECT * FROM RES_ANUAL_MES_ESPECIALIDAD WHERE ANIO= ?', [$año]);
    ...
    public function getReporte4Detalle(Request $request)
    {
        ...
        try {
            ...
            $data = DB::select('SELECT * FROM RES_ANUAL_MES_ESPECIALIDAD_DET WHERE ANIO= ? AND CODIGO_ESPECIALIDAD=? AND COD_MES =? ORDER BY NOMBRE_PRODUCTO ASC', [$año, $especialidad, $mes]);
